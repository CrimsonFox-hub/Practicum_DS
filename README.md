...
|---|---|---|---|
| [15_](15%20Прогнозирование%20энергопотребления%20производства) | Прогнозирование энергопотребления на металлопроизводстве  | `LightGBM` `NumPy` `CatBoost` `Pandas` `Sklearn` `Seaborn` `Matplotlib` | `ML`<br>`Data Analysis` |
